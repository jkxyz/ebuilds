...
# Based on Gentoo's net-misc/nextcloud-client-33.0.5 ebuild.
inherit cmake flag-o-matic qt-utils virtualx xdg
...
pkg_postinst() {
	...
	if ! has_version -r "dev-libs/qtkeychain[keyring]"; then
		elog "dev-libs/qtkeychain has not been built with the 'keyring' USE flag."
		elog "Please consider enabling the 'keyring' USE flag. Otherwise you may"
		elog "have to authenticate manually every time you start the Nextcloud client."
